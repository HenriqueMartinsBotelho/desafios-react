...
const Desafio4: React.FC = () => {
  ...
  const handleScreenClick = (
    ...
    let sub = coordinates.slice(0, pointerPosition);
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2 m-auto w-40">
        {coordinates.slice(0, pointerPosition).map((pos) => (
          <div key={`${pos[0]}-${pos[1]}`} className="flex">
            {`[${pos[0]}, ${pos[1]}]`},
          </div>
        ))}
      </div>
